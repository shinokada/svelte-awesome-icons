<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'person drowning solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'person drowning solid'
@prop ...restProps
-->
