<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'arrow up from ground water solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'arrow up from ground water solid'
@prop ...restProps
-->
