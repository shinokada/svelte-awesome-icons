<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'users between lines solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'users between lines solid'
@prop ...restProps
-->
