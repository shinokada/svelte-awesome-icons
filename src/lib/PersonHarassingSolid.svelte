<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'person harassing solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'person harassing solid'
@prop ...restProps
-->
