<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'object ungroup regular',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'object ungroup regular'
@prop ...restProps
-->
