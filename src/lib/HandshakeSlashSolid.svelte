<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'handshake slash solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'handshake slash solid'
@prop ...restProps
-->
