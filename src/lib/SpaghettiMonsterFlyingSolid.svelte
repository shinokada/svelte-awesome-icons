<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'spaghetti monster flying solid',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'spaghetti monster flying solid'
@prop ...restProps
-->
