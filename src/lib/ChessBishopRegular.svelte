<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'chess bishop regular',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'chess bishop regular'
@prop ...restProps
-->
