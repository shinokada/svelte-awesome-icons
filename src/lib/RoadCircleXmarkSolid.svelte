<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'road circle xmark solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'road circle xmark solid'
@prop ...restProps
-->
