<script lang="ts">
	...
	let {
		...
		title,
		desc,
		ariaLabel = 'brazilian real sign solid',
		...restProps
	}: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'brazilian real sign solid'
@prop ...restProps
-->
