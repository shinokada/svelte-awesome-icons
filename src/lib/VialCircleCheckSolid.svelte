<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'vial circle check solid',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'vial circle check solid'
@prop ...restProps
-->
