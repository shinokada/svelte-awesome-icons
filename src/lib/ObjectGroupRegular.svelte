<script lang="ts">
  ...
  let {
    ...
    title,
    desc,
    ariaLabel = 'object group regular',
    ...restProps
  }: Props = $props();
...
@prop title
@prop desc
@prop ariaLabel = 'object group regular'
@prop ...restProps
-->
