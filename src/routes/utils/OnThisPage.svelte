<script lang="ts">
  ...
  import ChevronDownOutline from './icons/ChevronDownOutline.svelte';
  interface LinkType {
    name: string;
    href?: string;
    rel?: string;
...
<div use:init>
  {#if headings.length}
    <Dropdown
      ...
      containerClass="w-64 z-20 dark:bg-stone-900 border border-gray-200 dark:border-gray-700 rounded-lg "
    >
